...
myApp.controller('customersCtrl',function($scope,$http,ngDialog,$modal,$timeout){
    ...
    var ModalInstanceCtrl = function ($scope, $modalInstance,$http,ngDialog) {
    	...
    	$scope.save = function(){
    		$scope.station.createTime = document.getElementById("createTime").value;
    		...
    		if(mtype==2){
    			 $http({
        	   		 method:'POST',
        				 url:'saveChangeStationDevice.do',
        				 params:saveparam,
