...
<script src="${ctx }/shenhai/js/indicator/indicatorGroupInfo.js"></script>
...
<div class="page-content" style="">
	...
	<form class="form-horizontal" role="form" name="myForm"  novalidate>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
						<input type="text" ng-model="m.code" name="code"  class="form-control" maxlength="10" required />
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
						<input type="text" ng-model="m.title" name="title"   class="form-control" maxlength="10" required />
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
							 <textarea class="form-control" ng-model="m.description" id="form-field-8" placeholder="" maxlength="50" rows=3 cols=20></textarea>
				</div>
			</div>
			<div class="space-4"></div>
