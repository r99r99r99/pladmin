...
<script src="${ctx }/shenhai/js/dictionary/unitgroup.js"></script>
...
<div class="page-content" style="">
    ...
    <div class="modal-body"> 
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
						<input type="text" id="form-field-1" ng-model="group.name" name="name" class="form-control" required/>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
						<textarea class="form-control" ng-model="group.description" id="form-field-8" maxlength="100" placeholder="" rows=3 cols=20></textarea>
				</div>
			</div>
			<div class="space-4"></div>
