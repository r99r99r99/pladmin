...
<script src="${ctx }/shenhai/js/firstpage/firstpagesystemInfo.js"></script>	
    ...
    <div class="modal-body"> 
		<form class="form-horizontal" role="form" name="myForm"  novalidate>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
							 <select id="selectError" ng-model="indicatorCode" class="form-control" name="indicatorCode"
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
							 <select id="selectError" ng-model="type" class="form-control" name="type"
