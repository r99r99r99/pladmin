		...
		<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<li><label>参数:</label>
						    <div class="vocation">
							    <multi-select-tree data-input-model="u.indicators" multi-select="false" ng-model="indicator"
					    ...
					    <li><label>&nbsp;</label><input name="" type="button" class="btn btn-primary" ng-click="check()" value="标记"/></li>
					    </ul>
					    </div>
...
<script src="${ctx }/shenhai/js/dataquery/dataCheck_init.js"></script>
...
<div class="page-content" style="">
    ...
    <div class="modal-body"> 
		<form class="form-horizontal" role="form" name="myForm"  novalidate>
			<input type="hidden" id="form-field-1" ng-model="m.inputString" />
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 操作状态 </label>

				<div class="col-sm-5">
							 <select id="selectError" ng-model="m.isactive" class="form-control" name="wpId"
							  ng-options="option.id as option.title for option in isactiveList" required>
							 </select>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
						<textarea class="form-control" ng-model="m.remark" id="form-field-8" placeholder="" rows=3 cols=20></textarea>
				</div>
			</div>
			<div class="space-4"></div>
