		...
		<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<li><label>参数:</label>
						    <div class="vocation">
							    <multi-select-tree data-input-model="u.indicators" multi-select="false" ng-model="indicator"
	                                   data-output-model="u.indicator" data-default-label="请选择监测参数."
					    ...
					    <li><label>&nbsp;</label><input name="" type="button" class="btn btn-primary" ng-click="addRow()" value="新增"/></li>
					    <li><label>&nbsp;</label><input name="" type="button" class="btn btn-primary" ng-click="deleRow()" value="删除"/></li>
						...
						<div class="row-fluid">
							<div class="span5">
								<div  ui-grid="gridOptions" ui-grid-selection ui-grid-importer ui-grid-exporter ui-grid-edit class="gridStyle" ></div>
							</div>
						</div>
				</div>
			</div>
...
<script src="${ctx }/shenhai/js/dataquery/manualDataImport_init.js"></script>
</body>
</html>
