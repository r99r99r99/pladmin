		...
		<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
					    ...
					    <li><label>站点</label>
						    <div class="vocation">
							    <select  ng-model="stationId" class="form-control"
	                              ng-change="showUser()" 
...
<script src="${ctx }/shenhai/js/sms/smsMouldInfo.js"></script>
    ...
    <div class="modal-body"> 
		<form class="form-horizontal" role="form" name="myForm"  novalidate>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
						<select  ng-model="stationId" class="form-control" name="stationId" id="stationId"
							  ng-options="option.id as option.title for option in stationList">
						</select>
