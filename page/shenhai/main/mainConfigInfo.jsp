...
<c:set var="ctx" value="${pageContext.request.contextPath}"/>
	...
	<body ng-app="myApp" ng-controller="customersCtrl"> 
		...
		<script src="${ctx }/liaohe/resources/assets/js/ajaxfileupload.js"></script>
		<script type="text/javascript" src="${ctx }/liaohe/js/main/mainConfigInfo.js"></script>
		<div class="main-container" id="main-container">
			...
			<%@ include file="../common/leftMenu.jsp" %>
				...
				<div class="main-content" >
				    ...
				    <li><label>&nbsp;</label><input name="" type="button" class="btn btn-primary" ng-click="deleMain()" value="删除"/></li>
				    </ul>
				    </div>
