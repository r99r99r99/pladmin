...
<script src="${ctx }/shenhai/js/main/stationDeviceMainInfo.js"></script>	
...
<div class="page-content" style="">
    ...
    <div class="modal-body"> 
		<form class="form-horizontal" role="form" name="myForm"  novalidate>
			...
			<input type="hidden" id="form-field-1" ng-model="station.madcId" />
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 例行维护 </label>

				<div class="col-sm-5">
							 <select id="selectError" ng-model="station.amconfigId" class="form-control"
							  ng-options="option.id as option.name for option in amcList">
							 </select>
				</div>
			</div>
			<div class="space-4"></div>
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 维护周期(天) </label>

				<div class="col-sm-5">
							 <input type="number" id="form-field-1" ng-model="station.mainNum" name="mainNum" maxlength="20" class="form-control"/>
				</div>
			</div>
			<div class="space-4"></div>
