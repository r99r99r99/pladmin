...
<script src="${ctx }/shenhai/js/station/stationDeviceInfo.js"></script>	
...
<div class="page-content" style="">
    ...
    <div class="modal-body"> 
		<form class="form-horizontal" role="form" name="myForm"  novalidate>
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 小数点位数 </label>

				<div class="col-sm-5">
							 <input type="number" id="form-field-1" ng-model="station.pointNum" name="pointNum" maxlength="20" class="form-control"/>
				</div>
			</div>
			<div class="space-4"></div>

			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 设备安装时间 </label>

				<div class="col-sm-5">
							<input name="createTime" ng-model="station.createTime" id="createTime" placeholder="安装时间"  type="text" 
